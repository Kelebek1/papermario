...
void N(func_802411A0_A173C0)(ScriptInstance* script, NpcAISettings* aiSettings, EnemyTerritoryThing* territory) {
    Enemy* enemy = script->owner1.enemy;
    Npc* npc = get_npc_unsafe(enemy->npcID);
    f32 temp_f24;
...
#else
INCLUDE_ASM(void, "world/area_hos/hos_02/A17210", hos_02_func_802411A0_A173C0, ScriptInstance* script, NpcAISettings* aiSettings, EnemyTerritoryThing* territory);
#endif
...
ApiStatus N(func_802428F4_A18B14)(ScriptInstance* script, s32 isInitialCall) {
    Enemy* enemy = script->owner1.enemy;
    Bytecode* args = script->ptrReadPos;
    Npc* npc = get_npc_unsafe(enemy->npcID);
    EnemyTerritoryThing territory;
    ...
    switch (script->functionTemp[0].s) {
        ...
        case 13:
            N(func_80242618_A18838)(script, aiSettings, territoryPtr);
            break;
        case 20:
